using EverginePrimitiveNullBug.MAUI.Evergine;
...
namespace EverginePrimitiveNullBug.MAUI.Evergine
{
    public partial class EvergineViewHandler : ViewHandler<EvergineView, AndroidSurfaceView>
    {
        ...
        internal void UpdateApplication(EvergineView view, string displayName)
        {
            ...
            () =>
            {
                this.ConfigureGraphicsContext(view.Application as EverginePrimitiveNullBug.MyApplication, this.androidSurface);
